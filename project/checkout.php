...
<section class="checkout">
   ...
   <h1 class="heading">Checkout Order</h1>
   ...
   <div class="row">
      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <input type="text" name="flat" required maxlength="50" placeholder="Enter building number" class="input">
               <p>Address 2<span>*</span></p>
               <input type="text" name="street" required maxlength="50" placeholder="Enter street name" class="input">
               <p>City<span>*</span></p>
         ...
         <input type="submit" value="Order" name="place_order" class="btn">
      </form>
      ...
      <div class="summary">
         ...
         ?>
         <div class="flex">
            <img src="<?= $fetch_get['image']; ?>" class="image" alt="">
            <div>
               <h3 class="name"><?= $fetch_get['name']; ?></h3>
               <p class="price"><i class="fas fa-dollar"></i> <?= $fetch_get['price']; ?> x 1</p>
            </div>
         </div>
         <?php
               }
         ...
         ?>
         <div class="flex">
            <img style="background-color: #BEBEBE; border-radius: 5px; padding: 5px;" src="<?= $fetch_product['image']; ?>" class="image" alt="">
            <div>
               <h3 class="name"><?= $fetch_product['name']; ?></h3>
               <p class="price"><i class="fas fa-dollar"></i> <?= $fetch_product['price']; ?> x <?= $fetch_cart['qty']; ?></p>
            </div>
         </div>
         <?php
                  }
         ...
         ?>
         <div class="grand-total"><span>Total:</span><p><i class="fas fa-dollar"></i> <?= $grand_total ?></p></div>
      </div>
