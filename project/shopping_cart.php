...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex">
         <p class="price"><i class="fas fa-dollar"></i> <?= $fetch_cart['price']; ?></p>
      ...
      <p class="sub-total">Delivery Charges: <h7 style="font-weight: bold;color: #12bb12;">FREE</h7></p>
      <p class="sub-total">Sub total: <span><i class="fas fa-dollar"></i> <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         <p>Total: <span><i class="fas fa-dollar"></i> <?= $grand_total; ?></span></p>
